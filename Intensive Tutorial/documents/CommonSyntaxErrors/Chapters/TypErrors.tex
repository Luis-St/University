...
\chapter*{Kategorie 1: Typfehler}
\label{ch:kategorie-1:-typfehler}
\addcontentsline{toc}{chapter}{Kategorie 1: Typfehler}
\endgroup


\section*{1. Zuweisung falscher Datentypen}
\addcontentsline{toc}{section}{1. Zuweisung falscher Datentypen}
...
\addcontentsline{toc}{section}{2. Vergleich inkompatibler Typen}
...
\addcontentsline{toc}{section}{3. Verwendung von Operatoren mit falschen Typen}
...
\addcontentsline{toc}{section}{4. Methodenaufrufe mit falschen Datentypen}
