...
namespace lsv12 {
	StationWagon::StationWagon(const std::string &numberPlate, const std::string &manufacturer, const int maxLoad, const bool sunRoof, const int numSeats)
	...
	void StationWagon::dump() {
		...
		std::cout << "  " << this->hasSunRoof() << "  " << this->numSeats;
	}
