...
Ein \texttt{String} ist \textbf{kein primitiver Datentyp}, sondern eine Klasse (Referenztyp). Er speichert Zeichenketten (Text).
...
\subsubsection*{Beschreibung}\\
Von "größerem" zu "kleinerem" Datentyp muss explizit gecastet werden. Kann zu Datenverlust führen!
